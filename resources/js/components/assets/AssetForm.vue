    ...
    <form class="space-y-6" @submit.prevent="submit">
        <div class="grid gap-6 md:grid-cols-2">
            <div class="grid gap-2">
                ...
                <Input id="name" v-model="form.name" required placeholder="e.g. Sony A7 III" />
            ...
            <div class="grid gap-2">
                ...
                <Input id="brand" v-model="form.brand" placeholder="e.g. Sony" />
            ...
            <div class="grid gap-2">
                ...
                <Input id="serial_number" v-model="form.serial_number" placeholder="Optional" />
                <InputError :message="form.errors.serial_number" />
            </div>

            <div class="grid gap-2">
                <Label for="model_number">Model number</Label>
                <Input id="model_number" v-model="form.model_number" placeholder="Optional" />
            ...
            <div class="grid gap-2 md:col-span-2">
                ...
                <Input id="current_location" v-model="form.current_location" placeholder="e.g. Main Sanctuary" />
            ...
            <div class="grid gap-2 md:col-span-2">
                ...
                <textarea
                    ...
                    v-model="form.notes"
                    rows="4"
                    class="border-input focus-visible:border-ring focus-visible:ring-ring/50 dark:bg-input/30 w-full rounded-md border bg-transparent px-3 py-2 text-sm shadow-xs transition-[color,box-shadow] outline-none focus-visible:ring-[3px]"
